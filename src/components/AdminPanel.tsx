...
import { ArrowLeft, Users, FileText, Layers, RefreshCw } from 'lucide-react';
      ...
      <main className="container mx-auto px-4 py-8 space-y-8">
        ...
        <Tabs defaultValue="users" className="space-y-6">
          ...
          <TabsContent value="invoices">
            <Card className="glass-card">
              <CardHeader>
                <CardTitle className="text-lg">Historial de Facturas por Usuario</CardTitle>
                <CardDescription>Haz clic en "Ver historial" para ver las facturas de cada usuario</CardDescription>
              </CardHeader>
              <CardContent>
                {isLoadingStats ? (
