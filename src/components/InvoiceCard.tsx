import { Invoice, InvoiceType, OperationType, OPERATION_TYPE_LABELS, INVOICE_TYPE_LABELS } from '@/types/invoice';
...
import { 
  ...
  ChevronDown, ChevronUp, Building, User, Calendar, Hash, Euro, Globe, FileCheck, Eye
} from 'lucide-react';
...
export function InvoiceCard({ 
  ...
  return (
    <>
      ...
      <InvoicePreview invoice={invoice} open={previewOpen} onOpenChange={setPreviewOpen} />
    </>
  );
}
